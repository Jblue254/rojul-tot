...
function MachineManagement() {
    ...
    const fetchMachines = async () => {
        try {
            ...
            console.error(error);
            showToast("Failed to fetch machine inventory records.");
        }
    };
    ...
    const addMachine = async () => {
        ...
        try {
            ...
            showToast("Machine cataloged and added successfully");
        } catch (error) {
            console.error(error);
            showToast("Failed to add machine parameters to database.");
        }
    };
    ...
    const updateMachine = async () => {
        try {
            ...
            showToast("Machine asset profile updated successfully");
        } catch (error) {
            console.error(error);
    ...
    const deleteMachine = async (id) => {
        ...
        try {
            ...
            fetchMachines();
            showToast("Machine registry entry removed successfully");
        } catch (error) {
            console.error(error);
            showToast("Failed to remove historical entry from system.");
        }
    };
